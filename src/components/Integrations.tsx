    ...
    <div className="h-full overflow-y-auto">
      <div className="p-6 space-y-8">
        ...
        <div>
          ...
          <p className="text-zinc-500 mt-1">Connected services and available tools</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-indigo-900/30 to-purple-900/30 border border-indigo-500/20 rounded-xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-bold">OpenClaw Gateway</h3>
              <p className="text-zinc-400 mt-1">Running on KORA's Mac mini</p>
              <div className="flex items-center gap-4 mt-2">
                <span className="text-sm text-green-400">● Connected</span>
                <span className="text-sm text-zinc-500">Version 2026.2.9</span>
                <span className="text-sm text-zinc-500">Model: Claude Opus</span>
              </div>
            </div>
